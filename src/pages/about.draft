...
export default ({ data }) => {
  ...
  return (
    ...
    >
      <Container>
        <Paragraph fill>
          <Img fixed={data.kendavidson.childImageSharp.fixed}></Img>
          <Img
            sizes={{
              ...data.kendavidson.childImageSharp.fixed,
              aspectRation: 16 / 9
            }}
          ></Img>
          <Heading>Hey, I'm Ken</Heading>
          <Paragraph fill>
            {" "}
          ...
          <Heading>Social Me</Heading>
          <Paragraph>
            You won't find me on <a href="https://www.facebook.com">Facebook</a>
            , <a href="https://www.twitter.com">Twitter</a>, or a number of
            other social sites/apps - before we had Carson I thought it
            important to start getting used concentrating on some other
            priorities and I've just continued the practice. Although attempting
            to raise a son with plugged in grandparents makes{" "}
